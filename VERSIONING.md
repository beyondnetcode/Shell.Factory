...
BeyondNet.Factory uses **Semantic Versioning (SemVer)** for clear, predictable version management.
...
|---------|---------|-------|
| `BeyondNetCode.Shell.Factory` | 1.0.0 | Core factory library |
| `BeyondNetCode.Shell.Factory.Installer` | 1.0.0 | DI extension methods |
